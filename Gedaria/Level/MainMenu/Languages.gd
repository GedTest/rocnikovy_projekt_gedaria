...
var languages = {
	"čeština":{
		...
		"pause":"Stisknutím [color=#004a23]tlačítka 'T'[/color] hru zastavíš a zobrazí se nabídka menu.",
	},
	"english":{
		...
		"raking_out_leaves_horizontal":"Vladimir can rake the leaves horizontally with his rakes. [color=#004a23]Hold down the 'Shift' key[/color]",
		...
		"pause":"[color=#004a23]Press the 'T'[/color] button to stop the game and display the menu.",
	},
	"polskie": {
		"start":"Zacząć gre",
		"load":"Wczytaj grę",
